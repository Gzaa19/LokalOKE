    ...
    return (
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 sm:pt-24 md:pt-28 lg:pt-30 pb-6 sm:pb-8 lg:pb-20">
        <div className="text-center">
          ...
          <button 
            onClick={goBack}
            className="inline-flex items-center gap-2 mt-4 bg-gradient-to-r from-sky-600 to-sky-800 text-white px-4 py-2 rounded-lg hover:from-sky-700 hover:to-sky-900 transition-all duration-300"
          >
    ...
    >
        <div className="mb-4 sm:mb-6">
          ...
          >
            ...
            <span className="relative z-10 text-sm sm:text-base">{getBackButtonText()}</span>
          </button>
        </div>
