            ...
            <div class="mx-auto grid justify-center gap-6 sm:grid-cols-2 md:max-w-6xl md:grid-cols-3">
                <div class="relative overflow-hidden rounded-xl border border-[#E8E8E8] bg-white/85 shadow-lg select-none p-3 md:p-4 transition duration-300 hover:border-[#7A7A7A] hover:shadow-lg hover:shadow-[#7A7A7A] hover:-translate-y-0.5">
                  <div class="relative min-h-[75px] rounded-md p-6 md:p-7 lg:p-8">
                    ...
                    <div class="space-y-2 flex-1 pt-10">
                      <h3 class="font-bold text-base md:text-lg">Lokasi OKE</h3>
                      <p class="text-sm text-muted-foreground">Kami menyajikan data lokasi yang akurat. Temukan UMKM terdekat Anda dengan peta interaktif dan petunjuk arah yang jelas.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="relative overflow-hidden rounded-xl border border-[#E8E8E8] bg-white/85 shadow-lg select-none p-3 md:p-4 transition duration-300 hover:border-[#7A7A7A] hover:shadow-lg hover:shadow-[#7A7A7A] hover:-translate-y-0.5">
                  <div class="relative min-h-[75px] rounded-md p-6 md:p-7 lg:p-8">
                    ...
                    <div class="space-y-2 flex-1 pt-10">
                      <h3 class="font-bold text-base md:text-lg">Informasi OKE</h3>
                      <p class="text-sm">Informasi lengkap dan terverifikasi. Lihat jam buka, daftar menu/jasa, fasilitas (parkir, WiFi, dll), dan info kontak yang up-to-date.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="relative overflow-hidden rounded-xl border border-[#E8E8E8] bg-white/85 shadow-lg select-none p-3 md:p-4 transition duration-300 hover:border-[#7A7A7A] hover:shadow-lg hover:shadow-[#7A7A7A] hover:-translate-y-0.5">
                  <div class="relative min-h-[75px] rounded-md p-6 md:p-7 lg:p-8">
                    ...
                    <div class="space-y-2 flex-1 pt-10">
                      <h3 class="font-bold text-base md:text-lg">Ulasan Jujur</h3>
                      <p class="text-sm text-muted-foreground">Lihat apa kata komunitas. Baca ulasan dan rating jujur dari pengunjung lain untuk membantu Anda menentukan pilihan terbaik.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="relative overflow-hidden rounded-xl border border-[#E8E8E8] bg-white/85 shadow-lg select-none p-3 md:p-4 transition duration-300 hover:border-[#7A7A7A] hover:shadow-lg hover:shadow-[#7A7A7A] hover:-translate-y-0.5">
                  <div class="relative min-h-[75px] rounded-md p-6 md:p-7 lg:p-8">
                    ...
                    <div class="space-y-2 flex-1 pt-10">
                      <h3 class="font-bold text-base md:text-lg">Pencarian Mudah</h3>
                      <p class="text-sm text-muted-foreground">Temukan yang Anda cari dengan cepat. Gunakan filter canggih berdasarkan kategori, lokasi, rating, atau yang sedang buka saat ini.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="relative overflow-hidden rounded-xl border border-[#E8E8E8] bg-white/85 shadow-lg select-none p-3 md:p-4 transition duration-300 hover:border-[#7A7A7A] hover:shadow-lg hover:shadow-[#7A7A7A] hover:-translate-y-0.5">
                  <div class="relative min-h-[75px] rounded-md p-6 md:p-7 lg:p-8">
                    ...
                    <div class="space-y-2 flex-1 pt-10">
                      <h3 class="font-bold text-base md:text-lg">Info Promo Terbaru</h3>
                      <p class="text-sm text-muted-foreground">Jangan lewatkan penawaran menarik. Dapatkan info promo spesial, diskon, atau produk baru langsung dari pemilik UMKM.</p>
                    </div>
                  </div>
                </div>
                ...
                <div class="relative overflow-hidden rounded-xl border border-[#E8E8E8] bg-white/85 shadow-lg select-none p-3 md:p-4 transition duration-300 hover:border-[#7A7A7A] hover:shadow-lg hover:shadow-[#7A7A7A] hover:-translate-y-0.5">
                  <div class="relative min-h-[75px] rounded-md p-6 md:p-7 lg:p-8">
                    ...
                    <div class="space-y-2 flex-1 pt-10">
                      <h3 class="font-bold text-base md:text-lg">100% Dukung Lokal</h3>
                      <p class="text-sm text-muted-foreground">Setiap pencarian, kunjungan, dan ulasan Anda adalah bentuk dukungan nyata untuk pertumbuhan bisnis tetangga dan ekonomi lokal Anda.</p>
                    </div>
                  </div>
                </div>
            </div>
