...
const Navbar = () => {
  ...
  return (
    <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        isScrolled 
          ? 'bg-slate-900/90 backdrop-blur-lg border-b border-slate-700/50 shadow-lg shadow-black/20' 
          : 'bg-transparent'
      }`}>
        ...
        <div className="flex items-center h-16">
          ...
          <div className="flex-1 flex justify-center">
            <div className="hidden md:flex items-center">
              <div className={`backdrop-blur-md rounded-full px-3 py-2 flex items-center space-x-2 transition-all duration-500 ${
                isScrolled 
                ...
                <a 
                  href="#beranda" 
                  className="bg-gradient-to-r from-blue-500 to-blue-600 text-white px-5 py-2 rounded-full transition-all duration-300 font-semibold text-sm shadow-md hover:shadow-lg hover:from-blue-600 hover:to-blue-700 transform hover:scale-105"
                >
                  Beranda
                </a>
                <a 
          ...
          <div className="hidden md:flex items-center">
            <button className={`transition-all duration-300 p-2 rounded-lg backdrop-blur-sm ${
              isScrolled 
                ? 'text-white/80 hover:text-white hover:bg-slate-700/50 border border-slate-600/50 hover:border-slate-500/50' 
      ...
      <div className={`md:hidden ${isMobileMenuOpen ? 'block' : 'hidden'}`}>
        <div className={`px-4 pt-3 pb-4 space-y-2 backdrop-blur-lg transition-all duration-500 ${
          isScrolled 
